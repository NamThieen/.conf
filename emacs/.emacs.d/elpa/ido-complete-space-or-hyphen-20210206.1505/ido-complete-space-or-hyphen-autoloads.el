;;; ido-complete-space-or-hyphen-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
`Ido-Complete-Space-Or-Hyphen mode' mode.  If the prefix argument is
...
Enable ido-complete-space-or-hyphen" t)
(autoload 'ido-complete-space-or-hyphen-disable "ido-complete-space-or-hyphen" "\
Disable ido-complete-space-or-hyphen" t)
